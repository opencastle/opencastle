      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Inscription</h5>
                <ol class="breadcrumb">
        ...
        <div class="row margin">
          <div class="input-field col s4">
            ...
            <label for="Pseudo" class="center-align">Pseudo</label>
          </div>
        </div>
        <div class="row margin">
          <div class="input-field col s4">
            ...
            <label for="email" data-error="Format" data-success="Ok" class="center-align">Email</label>
          </div>
        </div>
        <div class="row margin">
          <div class="input-field col s4">
            <i class="mdi-action-lock-outline prefix"></i>
            <input id="MotDePasse" type="password" class="validate">
        ...
        <div class="row margin">
          <div class="input-field col s4">
            <i class="mdi-action-lock-outline prefix"></i>
            <input id="MotDePasse-again" type="password" class="validate">
            <label for="MotDePasse-again">Répétez le mot de passe</label>
          </div>
        </div>
        <div class="row">
          <div class="input-field col s4">
            <a href="index.html" class="btn waves-effect waves-light col s5">Inscription </a> <p class="margin right medium-small sign-up"> Déjà un compte ?<a href="connexion.php"> Connexion</a></p>
          </div>
        </div>
      </form>
                                </div>
